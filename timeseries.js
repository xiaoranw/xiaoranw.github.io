...
// Nathan Yau, the interactive line chart from "Life Expectancy": http://projects.flowingdata.com/life-expectancy/
    ...
    startAge = 0,
    endAge = 40,
    y = d3.scale.linear().domain([35, 0]).range([0 + margin, h - margin]),
    x = d3.scale.linear().domain([2003, 2015]).range([0 + margin - 1, w]),
...
d3.text('finalprojectTable_FinalC.csv', 'text/csv', function (text) {
